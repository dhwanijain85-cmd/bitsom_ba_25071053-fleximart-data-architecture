...
-- ============================================================================
-- This file contains SQL queries for business analysis scenarios
-- Run these queries after the ETL pipeline has loaded data into the database
-- ============================================================================
...
-- customers who have placed at least 2 orders and spent more than Rs.5,000.
...
-- generated. Only include categories that have generated more than Rs.10,000
